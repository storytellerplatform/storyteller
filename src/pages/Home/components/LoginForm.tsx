...
const LoginForm: React.FC<LoginFormProps> = ({ showLoginForm, setShowLoginForm }) => {
  ...
  return (
    <div className={classNames(`fixed top-0 right-0 flex flex-col gap-4 h-screen w-5/12 max-w-full px-24 pt-10 bg-white z-50 overflow-auto transition-all duration-150 ease-in`,
      { ' translate-x-full': !showLoginForm })}
    >
