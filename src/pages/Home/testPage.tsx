...
const TestHome = () => {
  return (
    <main className='relative px-8 flex flex-row justify-evenly w-full bg-gradient-to-r from-zinc-950 via-zinc-900 via-50% to-zinc-500 text-white'>
      ...
      <div className='flex flex-col gap-12 mt-28'>
        ...
        <h3 className='text-2xl font-semibold'> 將你的故事、詩或任何文字轉換為美妙的音樂 </h3>
