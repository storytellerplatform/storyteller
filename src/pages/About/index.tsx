    ...
    <div className='flex w-full pt-12'>
      ...
      */}
      <main className='w-11/12 flex flex-col gap-4 text-white pr-12'>
        <header className='mb-4 text-white font-extrabold text-5xl'>關於我們</header>
        ...
        <div className='grid grid-cols-2 gap-y-4'>
          ...
          */}
          <div className='w-full'>
            <h3 className='mb-4 text-white font-bold text-4xl'>簡述</h3>

            <p className='mb-2 text-lg w-8/12'>
          ...
          */}
          <div className='w-full'>
            <h3 className='mb-4 text-white font-bold text-4xl'>團隊介紹</h3>
          ...
          */}
          <div className='w-full'>
            <h3 className='mb-4 text-white font-bold text-4xl'>情緒分析技術</h3>
          ...
          */}
          <div className='w-full'>
            <h3 className='mb-4 text-white font-bold text-4xl'>音樂生成技術</h3>
